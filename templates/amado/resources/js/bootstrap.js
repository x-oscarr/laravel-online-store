...
try {
    ...
    window.$.extend(require('bootstrap/dist/js/bootstrap.min'));
    window.$.extend(require('owl.carousel'));
    window.$.extend(require('owl.carousel/dist/assets/owl.carousel.css'));
    window.$.extend(require('webpack-jquery-ui'));
